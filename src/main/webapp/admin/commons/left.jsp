...
<section id="secondary_bar">
	...
	<aside id="sidebar" class="column" style="height: 602px;">
		...
		<h3>商品管理</h3>
		<ul class="toggle">
			<li class="icn_categories"><a href="${ctx }admin/goods/category_list.do">分类管理</a></li>
			<li class="icn_edit_article"><a href="${ctx }admin/goods/product_list.do">商品管理</a></li>
		</ul>
		<h3>新闻管理</h3>
		<ul class="toggle">
			<li class="icn_add_user"><a href="${ctx }admin/news/news_list.do">新闻管理</a></li>
		</ul>
		<h3>反馈管理</h3>
		<ul class="toggle">
			<li class="icn_folder"><a href="${ctx }admin/feedback/feedback_list.do">反馈管理</a></li>
		</ul>
		<h3>系统管理</h3>
		<ul class="toggle">
			<li class="icn_settings"><a href="${ctx }admin/sys/user_list.do">用户管理</a></li>
			<li class="icn_security"><a href="${ctx }admin/sys/role_list.do">角色管理</a></li>
			<li class="icn_jump_back"><a href="${ctx }admin/sys/log_list.do">日志管理</a></li>
			<li class="icn_jump_back"><a href="${ctx }admin/sys/company_detail.do">公司管理</a></li>
			<li class="icn_settings"><a href="${ctx }admin/sys/html/gennerate.jsp">生成管理</a></li>
		</ul>
		<footer>
			<hr />
