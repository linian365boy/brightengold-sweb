	...
	<jsp:include page="/admin/commons/message.jsp"/>
		...
		<div id="tab1" class="tab_content">
			<form action="#" class="form-horizontal">
				...
				<div style="margin: 10px 50px;">
					<input type="button" class="btn btn-danger" value="预览News页面" onclick="purviewNews();" title="预览News静态页面"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="button" class="btn btn-danger" value="生成News页面" onclick="gennerateNews();" title="生成News静态页面"/>
				</div>
				<div style="margin: 10px 50px;">
